...
function(_check_dependencies)
  ...
  foreach(dependency IN LISTS dependencies_list)
    ...
    if(EXISTS "${dependencies_dir}/${file}")
      file(SHA256 "${dependencies_dir}/${file}" downloaded_hash)
      if(NOT downloaded_hash STREQUAL hash)
        message(WARNING "Cached ${label} archive failed SHA-256 verification; downloading it again")
